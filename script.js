...
window.onSpotifyWebPlaybackSDKReady = () => {
    ...
    const musicasEJogos = {
        "Kansas theme": "Carry On Wayward Son",
        "AC/DC theme":"Back In Black",
        "Guns N Roses theme":"Welcome to the Jungle",
        "Poison theme":"Nothing but a Good Time",
        "Mötley Crüe theme song":"Dr.Feelgood",
        "Sammy Hagar theme (area 1)":"There's Only One Way To Rock",
        "Twisted Sister theme":"We're Not Gonna Take It",
        "Sammy Hagar theme":"I Can't Drive 55",
        "AC/DC theme":"Highway to Hell",
        "AC/DC theme":"T.N.T",
    };
    ...
    player.addListener('ready', ({ device_id }) => {
        ...
        const connect_to_device = () => {
            let album_uri = "https://open.spotify.com/playlist/5ITKr1Ddv9yhrJ2MJlAcmX?si=0f3090b29d2942a5";
